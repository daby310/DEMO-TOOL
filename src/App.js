...
// import Form1 from "./Forms/Form1/index.js"
// import Form2 from "./Forms/Form2/index.js"
...
//                   <Nav.Item>
//                   <Nav.Link eventKey = {`fr${form.fr}`} >{`FR${form.fr}`}</Nav.Link>
//                 </Nav.Item>))}
//               </Nav>
//             </Col>
//             <Col sm={9}>
//               <Tab.Content>
//                 {Object.keys(formData).map((form)=>(
//                   <Tab.Pane eventKey = {`fr${form.fr}`}>
//                     <Form1 fr={form.fr} levels={form.levels}></Form1>
//                   </Tab.Pane>
//                 ))}
//               </Tab.Content>
//             </Col>
